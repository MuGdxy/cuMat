...
Value::Value(const std::int64_t i)
    : int_(i)
    , type_(INT)
{
}

Value::Value(const std::int32_t i)
    : int_(static_cast<std::int64_t>(i))
    , type_(INT)
{
}

Value::Value(const std::uint64_t i)
    : int_(static_cast<std::int64_t>(i))
    , type_(INT)
{
}

Value::Value(const std::uint32_t i)
    : int_(static_cast<std::int64_t>(i))
    , type_(INT)
{
}

Value::Value(const double f)
    : float_(f)
    , type_(FLOAT)
{
}
...
std::pair<std::map<std::string, Value>::iterator, bool> Object::Insert(
