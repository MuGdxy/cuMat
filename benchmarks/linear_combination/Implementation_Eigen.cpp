...
void benchmark_Eigen(const std::vector<std::string>& parameterNames,
    ...
    for(int config = 0; config < numConfigs; ++config)
    {
        ...
        for(int run = 0; run < runs; ++run)
        {
            ...
            for(int subrun = 0; subrun < subruns; ++subrun)
            {
                ...
                {
                    case 1:
                        (vectors[0] * factors[0]).eval();
                        break;
                    case 2:
                        (vectors[0] * factors[0] + vectors[1] * factors[1]).eval();
                        break;
                    case 3:
                        (vectors[0] * factors[0] + vectors[1] * factors[1]
                         + vectors[2] * factors[2])
                            .eval();
                        break;
                    case 4:
                        (vectors[0] * factors[0] + vectors[1] * factors[1]
                         + vectors[2] * factors[2] + vectors[3] * factors[3])
                            .eval();
                        break;
                    case 5:
                        (vectors[0] * factors[0] + vectors[1] * factors[1]
                    ...
                    case 6:
                        (vectors[0] * factors[0] + vectors[1] * factors[1]
                         + vectors[2] * factors[2] + vectors[3] * factors[3]
                         + vectors[4] * factors[4] + vectors[5] * factors[5])
                            .eval();
                        break;
                    case 7:
                        (vectors[0] * factors[0] + vectors[1] * factors[1]
                    ...
                    case 8:
                        (vectors[0] * factors[0] + vectors[1] * factors[1]
                         + vectors[2] * factors[2] + vectors[3] * factors[3]
                         + vectors[4] * factors[4] + vectors[5] * factors[5]
                         + vectors[6] * factors[6] + vectors[7] * factors[7])
                            .eval();
                        break;
                    case 9:
                        (vectors[0] * factors[0] + vectors[1] * factors[1]
                    ...
                    case 10:
                        (vectors[0] * factors[0] + vectors[1] * factors[1]
                         ...
                         + vectors[4] * factors[4] + vectors[5] * factors[5]
                         + vectors[6] * factors[6] + vectors[7] * factors[7]
                         + vectors[8] * factors[8] + vectors[9] * factors[9])
                            .eval();
                        break;
                }
            }
