...
struct traits<MatrixBlock<_Scalar, _Rows, _Columns, _Batches, _Flags, _MatrixType>>
{
    ...
    enum
    {
        ...
        AccessFlags          = ReadCwise | WriteCwise
                      | (traits<_MatrixType>::AccessFlags & RWCwise ? RWCwise : 0)
                      | (traits<_MatrixType>::AccessFlags & RWCwiseRef ? RWCwiseRef : 0)
    };
...
template <typename _Scalar, int _Rows, int _Columns, int _Batches, int _Flags, typename _MatrixType>
class MatrixBlock
    : public CwiseOp<MatrixBlock<_Scalar, _Rows, _Columns, _Batches, _Flags, _MatrixType>>
{
  public:
    using Type = MatrixBlock<_Scalar, _Rows, _Columns, _Batches, _Flags, _MatrixType>;
    using MatrixType = _MatrixType;
    using Base =
        MatrixBase<MatrixBlock<_Scalar, _Rows, _Columns, _Batches, _Flags, _MatrixType>>;
    CUMAT_PUBLIC_API
