...
class DevicePointer
{
  ...
  public:
    ...
    __host__ __device__ DevicePointer()
        : pointer_(nullptr)
        , counter_(nullptr)
        , context_(nullptr)
    {
    ...
    __host__ __device__ DevicePointer(const DevicePointer<T>& rhs)
    ...
    __host__ __device__ DevicePointer(DevicePointer<T>&& rhs) noexcept
    ...
    __host__ __device__ DevicePointer<T>& operator=(const DevicePointer<T>& rhs)
    {
        release();
        pointer_ = rhs.pointer_;
        counter_ = rhs.counter_;
    ...
    __host__ __device__ DevicePointer<T>& operator=(DevicePointer<T>&& rhs) noexcept
    {
        release();
        pointer_     = std::move(rhs.pointer_);
        counter_     = std::move(rhs.counter_);
    ...
    __host__ __device__ void swap(DevicePointer<T>& rhs) throw()
    {
    ...
    __host__ __device__ ~DevicePointer() { release(); }
