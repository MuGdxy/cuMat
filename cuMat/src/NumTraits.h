...
struct NumTraits
{
    ...
    */
    ...
    /**
         ...
         */
    static constexpr CUMAT_STRONG_INLINE ElementalType epsilon()
    {
...
struct NumTraits<float>
{
    ...
    static constexpr CUMAT_STRONG_INLINE RealType epsilon()
    {
...
template <>
struct isPrimitive<cfloat> : std::integral_constant<bool, true>
{
};
template <>
struct isPrimitive<cdouble> : std::integral_constant<bool, true>
{
};
...
{
    static __host__ __device__ CUMAT_STRONG_INLINE T conj(const T& v)
    {
        return v;
    }
};
...
{
    static __host__ __device__ CUMAT_STRONG_INLINE cfloat conj(const cfloat& v)
    {
...
{
    static __host__ __device__ CUMAT_STRONG_INLINE cdouble conj(const cdouble& v)
    {
        return ::thrust::conj(v);
    }
};
