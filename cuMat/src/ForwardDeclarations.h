...
template <typename _MatrixType>
class SparseMatrixDirectAccess;
}  // namespace internal
...
class AsDiagonalOp;
template <typename _Child>
class ExtractDiagonalOp;
template <typename _Child, bool _Imag, bool _Lvalue>
class ExtractComplexPartOp;
...
//unary
template <typename _Scalar>
struct UnaryMathFunctor_cwiseNegate;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseAbs;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseAbs2;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseInverse;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseInverseCheck;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseExp;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseLog;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseLog1p;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseLog10;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseSqrt;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseRsqrt;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseCbrt;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseRcbrt;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseSin;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseCos;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseTan;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseAsin;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseAcos;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseAtan;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseSinh;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseCosh;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseTanh;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseAsinh;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseAcosh;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseAtanh;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseCeil;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseFloor;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseRound;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseErf;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseErfc;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseLgamma;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseLogicalNot;
template <typename _Scalar>
struct UnaryMathFunctor_cwiseBinaryNot;
template <typename _Scalar>
struct UnaryMathFunctor_conjugate;
//casting
template <typename _Source, typename _Target>
struct CastFunctor;
//binary
template <typename _Scalar>
struct BinaryMathFunctor_cwiseAdd;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseSub;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseMul;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseDot;  ///< cwise dot-product of the two arguments. Only differs from cwiseMul on vector types
template <typename _Scalar>
struct BinaryMathFunctor_cwiseDiv;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseMod;
template <typename _Scalar>
struct BinaryMathFunctor_cwisePow;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseBinaryAnd;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseBinaryOr;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseBinaryXor;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseLogicalAnd;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseLogicalOr;
template <typename _Scalar>
struct BinaryMathFunctor_cwiseLogicalXor;
template <typename _Scalar>
struct BinaryLogicFunctor_cwiseEqual;
template <typename _Scalar>
struct BinaryLogicFunctor_cwiseNequal;
template <typename _Scalar>
struct BinaryLogicFunctor_cwiseLess;
template <typename _Scalar>
struct BinaryLogicFunctor_cwiseGreater;
template <typename _Scalar>
struct BinaryLogicFunctor_cwiseLessEq;
template <typename _Scalar>
struct BinaryLogicFunctor_cwiseGreaterEq;
//for reductions
template <typename _Scalar>
struct Sum;
template <typename _Scalar>
