...
class SparseExpressionOp
    : public SparseMatrixBase<SparseExpressionOp<_Child, _SparseFlags>>
{
  public:
  ...
  public:
    SparseExpressionOp(const MatrixBase<_Child>&            child,
                       const SparsityPattern<_SparseFlags>& sparsityPattern)
