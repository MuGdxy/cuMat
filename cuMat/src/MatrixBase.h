...
class MatrixBase
{
  public:
    ...
    */
    __host__ __device__ CUMAT_STRONG_INLINE _Derived& derived()
    {
    ...
    */
    __host__ __device__ CUMAT_STRONG_INLINE const _Derived& derived() const
    {
	...
	*/
    __host__ __device__ CUMAT_STRONG_INLINE Index size() const
    {
    ...
    typedef Matrix<typename internal::traits<_Derived>::Scalar,
    ...
    */
    eval_t eval() const { return eval_t(derived()); }
    ...
    */
    ...
    {
        CUMAT_STATIC_ASSERT(internal::traits<_Derived>::RowsAtCompileTime == 1
    ...
    */
    ...
    MatrixBlock<typename internal::traits<_Derived>::Scalar, NRows, NColumns, NBatches, internal::traits<_Derived>::Flags, const _Derived> block(
        Index start_row,
        Index start_column,
        Index start_batch,
	...
	*/
    MatrixBlock<typename internal::traits<_Derived>::Scalar, Dynamic, Dynamic, Dynamic, internal::traits<_Derived>::Flags, const _Derived> block(
	...
	*/
    MatrixBlock<typename internal::traits<_Derived>::Scalar, 1, internal::traits<_Derived>::ColsAtCompileTime, internal::traits<_Derived>::BatchesAtCompileTime, internal::traits<_Derived>::Flags, const _Derived> row(
        Index row) const
    {
        CUMAT_ERROR_IF_NO_NVCC(row)
        CUMAT_ASSERT_ARGUMENT(row >= 0);
        CUMAT_ASSERT_ARGUMENT(row < rows());
        return MatrixBlock<typename internal::traits<_Derived>::Scalar,
                           1,
                           internal::traits<_Derived>::ColsAtCompileTime,
                           internal::traits<_Derived>::BatchesAtCompileTime,
                           internal::traits<_Derived>::Flags,
                           const _Derived>(derived(), 1, cols(), batches(), row, 0, 0);
    }
	...
	*/
    MatrixBlock<typename internal::traits<_Derived>::Scalar, internal::traits<_Derived>::RowsAtCompileTime, 1, internal::traits<_Derived>::BatchesAtCompileTime, internal::traits<_Derived>::Flags, const _Derived> col(
        Index column) const
    {
        ...
        return MatrixBlock<typename internal::traits<_Derived>::Scalar,
                           ...
                           internal::traits<_Derived>::BatchesAtCompileTime,
                           internal::traits<_Derived>::Flags,
                           const _Derived>(derived(), rows(), 1, batches(), 0, column, 0);
    }
	...
	*/
    MatrixBlock<typename internal::traits<_Derived>::Scalar, internal::traits<_Derived>::RowsAtCompileTime, internal::traits<_Derived>::ColsAtCompileTime, 1, internal::traits<_Derived>::Flags, const _Derived> slice(
        Index batch) const
    {
        ...
        return MatrixBlock<typename internal::traits<_Derived>::Scalar,
                           ...
                           1,
                           internal::traits<_Derived>::Flags,
                           const _Derived>(derived(), rows(), cols(), 1, 0, 0, batch);
    }
  ...
  private:
    template <int N>
    MatrixBlock<typename internal::traits<_Derived>::Scalar, N, 1, internal::traits<_Derived>::BatchesAtCompileTime, internal::traits<_Derived>::Flags, const _Derived> segmentHelper(
        Index start, std::true_type) const
    {
        //column vector
        CUMAT_ASSERT_ARGUMENT(start >= 0);
        CUMAT_ASSERT_ARGUMENT(start + N <= rows());
        return MatrixBlock<typename internal::traits<_Derived>::Scalar, N, 1, internal::traits<_Derived>::BatchesAtCompileTime, internal::traits<_Derived>::Flags, const _Derived>(
            derived(), N, 1, batches(), start, 0, 0);
    }

    template <int N>
    MatrixBlock<typename internal::traits<_Derived>::Scalar, 1, N, internal::traits<_Derived>::BatchesAtCompileTime, internal::traits<_Derived>::Flags, const _Derived> segmentHelper(
        Index start, std::false_type) const
    {
        //row vector
        CUMAT_ASSERT_ARGUMENT(start >= 0);
        CUMAT_ASSERT_ARGUMENT(start + N <= cols());
        return MatrixBlock<typename internal::traits<_Derived>::Scalar, 1, N, internal::traits<_Derived>::BatchesAtCompileTime, internal::traits<_Derived>::Flags, const _Derived>(
  ...
  public:
	...
	*/
    ...
    segment(Index start) const -> decltype(segmentHelper<N>(
        start, std::integral_constant<bool, internal::traits<_Derived>::ColsAtCompileTime == 1>()))
    {
        CUMAT_ERROR_IF_NO_NVCC(segment)
        CUMAT_STATIC_ASSERT((internal::traits<_Derived>::RowsAtCompileTime == 1
                             || internal::traits<_Derived>::ColsAtCompileTime == 1),
                            "segment can only act on compile-time vectors");
        return segmentHelper<N>(
            start, std::integral_constant<bool, internal::traits<_Derived>::ColsAtCompileTime == 1>());
    }
  ...
  private:
    MatrixBlock<typename internal::traits<_Derived>::Scalar, Dynamic, 1, internal::traits<_Derived>::BatchesAtCompileTime, internal::traits<_Derived>::Flags, const _Derived> segmentHelper(
        Index start, Index length, std::true_type) const
    {
        ...
        return MatrixBlock<typename internal::traits<_Derived>::Scalar,
                           ...
                           internal::traits<_Derived>::BatchesAtCompileTime,
                           internal::traits<_Derived>::Flags,
                           const _Derived>(derived(), length, 1, batches(), start, 0, 0);
    }
    MatrixBlock<typename internal::traits<_Derived>::Scalar, 1, Dynamic, internal::traits<_Derived>::BatchesAtCompileTime, internal::traits<_Derived>::Flags, const _Derived> segmentHelper(
        Index start, Index length, std::false_type) const
    {
        ...
        return MatrixBlock<typename internal::traits<_Derived>::Scalar,
                           ...
                           internal::traits<_Derived>::BatchesAtCompileTime,
                           internal::traits<_Derived>::Flags,
                           const _Derived>(derived(), 1, length, batches(), 0, start, 0);
    }
  ...
  public:
	...
	*/
    auto segment(Index start, Index length) const -> decltype(segmentHelper(
        start, length, std::integral_constant<bool, internal::traits<_Derived>::ColsAtCompileTime == 1>()))
    {
        CUMAT_ERROR_IF_NO_NVCC(segment)
        CUMAT_STATIC_ASSERT((internal::traits<_Derived>::RowsAtCompileTime == 1
                             || internal::traits<_Derived>::ColsAtCompileTime == 1),
        ...
        return segmentHelper(
            start,
            length,
            std::integral_constant<bool, internal::traits<_Derived>::ColsAtCompileTime == 1>());
    }
...
#undef UNARY_OP_ACCESSOR
    ...
    */
    ...
    ExtractComplexPartOp<_Derived, false, false> real() const
    {
        ...
        CUMAT_STATIC_ASSERT(internal::NumTraits<typename internal::traits<_Derived>::Scalar>::IsComplex,
...
#define BINARY_OP_ACCESSOR(Name)                                                                            \
    ...
    BinaryOp<_Derived, _Right, functor::BinaryMathFunctor_##Name<Scalar>> Name(                             \
        const MatrixBase<_Right>& rhs) const                                                                \
    {                                                                                                       \
        CUMAT_ERROR_IF_NO_NVCC(Name)                                                                        \
        return BinaryOp<_Derived, _Right, functor::BinaryMathFunctor_##Name<Scalar>>(                       \
            derived(), rhs.derived());                                                                      \
    }                                                                                                       \
    template <typename _Right,                                                                              \
              typename T = typename std::enable_if<                                                         \
                  CUMAT_NAMESPACE internal::canBroadcast<_Right, Scalar>::value,                            \
                  BinaryOp<_Derived, HostScalar<Scalar>, functor::BinaryMathFunctor_##Name<Scalar>>>::type> \
    T Name(const _Right& rhs) const                                                                         \
    {                                                                                                       \
        CUMAT_ERROR_IF_NO_NVCC(Name)                                                                        \
        return BinaryOp<_Derived, HostScalar<Scalar>, functor::BinaryMathFunctor_##Name<Scalar>>(           \
            derived(), HostScalar<Scalar>(rhs));                                                            \
    }
#define BINARY_OP_ACCESSOR_INV(Name)                                                                        \
    template <typename _Left>                                                                               \
    BinaryOp<_Left, _Derived, functor::BinaryMathFunctor_##Name<Scalar>> Name##Inv(                         \
        const MatrixBase<_Left>& lhs) const                                                                 \
    {                                                                                                       \
        CUMAT_ERROR_IF_NO_NVCC(Name)                                                                        \
        return BinaryOp<_Left, _Derived, functor::BinaryMathFunctor_##Name<Scalar>>(                        \
            lhs.derived(), derived());                                                                      \
    }                                                                                                       \
    template <typename _Left,                                                                               \
              typename T = typename std::enable_if<                                                         \
                  CUMAT_NAMESPACE internal::canBroadcast<_Left, Scalar>::value,                             \
                  BinaryOp<HostScalar<Scalar>, _Derived, functor::BinaryMathFunctor_##Name<Scalar>>>::type> \
    T Name##Inv(const _Left& lhs) const                                                                     \
    {                                                                                                       \
        CUMAT_ERROR_IF_NO_NVCC(Name)                                                                        \
        return BinaryOp<HostScalar<Scalar>, _Derived, functor::BinaryMathFunctor_##Name<Scalar>>(           \
            HostScalar<Scalar>(lhs), derived());                                                            \
    }
...
#undef BINARY_OP_ACCESSOR_INV
    ...
    */
    ...
    UnaryOp<_Derived, Functor> binaryExpr(const Right& rhs,
                                          const Functor& functor = Functor()) const
    {
	...
	*/
    ...
    ReductionOp_StaticSwitched<_Derived, functor::LogicalAnd<Scalar>, axis, Algorithm> all() const
    {
        ...
        CUMAT_STATIC_ASSERT((std::is_same<Scalar, bool>::value),
                            "'all' can only be applied to boolean matrices");
	...
	*/
    ...
    ReductionOp_StaticSwitched<_Derived, functor::LogicalOr<Scalar>, axis, Algorithm> any() const
    {
        ...
        CUMAT_STATIC_ASSERT((std::is_same<Scalar, bool>::value),
                            "'any' can only be applied to boolean matrices");
	...
	*/
    ...
    ReductionOp_StaticSwitched<_Derived, functor::BitwiseAnd<Scalar>, axis, Algorithm> bitwiseAnd() const
    {
        ...
        CUMAT_STATIC_ASSERT(std::is_integral<Scalar>::value,
                            "'bitwiseAnd' can only be applied to integral matrices");
	...
	*/
    ...
    ReductionOp_StaticSwitched<_Derived, functor::BitwiseOr<Scalar>, axis, Algorithm> bitwiseOr() const
    {
        ...
        CUMAT_STATIC_ASSERT(std::is_integral<Scalar>::value,
                            "'bitwiseOr' can only be applied to integral matrices");
	...
	* \tparam axis the reduction axis, by default, reduction is performed among all axis
	*/
    template <typename _Functor, int axis = Axis::Row | Axis::Column | Axis::Batch, typename Algorithm = ReductionAlg::Auto>
    ReductionOp_StaticSwitched<_Derived, _Functor, axis, Algorithm> reduction(
        const _Functor& functor = _Functor(), const Scalar& initialValue = Scalar(0)) const
    {
	...
	*/
    ...
    ReductionOp_DynamicSwitched<_Derived, _Functor, Algorithm> reduction(
        int axis, const _Functor& functor = _Functor(), const Scalar& initialValue = Scalar(0)) const
    {
        CUMAT_ERROR_IF_NO_NVCC(reduction)
    ...
    */
    template <typename Algorithm = ReductionAlg::Auto>
    ReductionOp_StaticSwitched<ExtractDiagonalOp<_Derived>, functor::Sum<Scalar>, Axis::Row | Axis::Column, Algorithm> trace() const
    {
    ...
    using DotReturnType =
        ReductionOp_StaticSwitched<BinaryOp<_Derived, _Other, functor::BinaryMathFunctor_cwiseDot<Scalar>>,
    ...
    */
    ...
    DotReturnType<_Other, Algorithm> dot(const MatrixBase<_Other>& rhs) const
    {
        ...
        CUMAT_STATIC_ASSERT(internal::traits<_Other>::RowsAtCompileTime == 1
                                || internal::traits<_Other>::ColsAtCompileTime == 1,
    ...
    using SquaredNormReturnType =
        ReductionOp_StaticSwitched<UnaryOp<_Derived, functor::UnaryMathFunctor_cwiseAbs2<Scalar>>,
    ...
    */
    ...
    template <typename Algorithm = ReductionAlg::Auto>
    using NormReturnType =
        UnaryOp<ReductionOp_StaticSwitched<UnaryOp<_Derived, functor::UnaryMathFunctor_cwiseAbs2<Scalar>>,
                                           functor::Sum<typename functor::UnaryMathFunctor_cwiseAbs2<Scalar>::ReturnType>,
                                           Axis::Row | Axis::Column,
                                           Algorithm>,
    ...
    */
    ...
    {
        CUMAT_STATIC_ASSERT(Rows >= 1 && Rows <= 4,
                            "This matrix must be a compile-time 1x1, 2x2, 3x3 or 4x4 matrix");
        CUMAT_STATIC_ASSERT(Columns >= 1 && Columns <= 4,
                            "This matrix must be a compile-time 1x1, 2x2, 3x3 or 4x4 matrix");
        CUMAT_STATIC_ASSERT(Rows == Columns, "This matrix must be symmetric");
        CUMAT_STATIC_ASSERT(Rows >= 1 && internal::traits<InverseType>::RowsAtCompileTime,
                            "The output matrix must have the same compile-time size as this matrix");
        CUMAT_STATIC_ASSERT(Columns >= 1 && internal::traits<InverseType>::ColsAtCompileTime,
                            "The output matrix must have the same compile-time size as this matrix");
        CUMAT_STATIC_ASSERT(
            CUMAT_IMPLIES(Batches > 0 && internal::traits<InverseType>::BatchesAtCompileTime > 0,
                          Batches == internal::traits<InverseType>::BatchesAtCompileTime),
            "This matrix and the output matrix must have the same batch size");
        CUMAT_ASSERT_DIMENSION(batches() == inverseOut.batches());

        CUMAT_STATIC_ASSERT(internal::traits<DetType>::RowsAtCompileTime == 1,
                            "The determinant output must be a (batched) scalar, i.e. compile-time 1x1 matrix");
        CUMAT_STATIC_ASSERT(internal::traits<DetType>::ColsAtCompileTime == 1,
                            "The determinant output must be a (batched) scalar, i.e. compile-time 1x1 matrix");
        CUMAT_STATIC_ASSERT(
            CUMAT_IMPLIES(Batches > 0 && internal::traits<DetType>::BatchesAtCompileTime > 0,
                          Batches == internal::traits<DetType>::BatchesAtCompileTime),
            "This matrix and the determinant matrix must have the same batch size");
        CUMAT_ASSERT_DIMENSION(batches() == detOut.batches());

        CUMAT_NAMESPACE ComputeInverseWithDet<_Derived, Rows, InverseType, DetType>::run(
            derived(), inverseOut, detOut);
    }
    ...
    SparseExpressionOp<Type, _SparseFlags> sparseView(const SparsityPattern<_SparseFlags>& pattern)
    {
...
struct MatrixReadWrapper
{
  ...
  public:
    ...
    */
    using type =
        typename std::conditional<bool(sufficient), _Derived, typename _Derived::eval_t>::type;
