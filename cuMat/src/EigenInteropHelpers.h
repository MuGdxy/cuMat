...
struct StorageCuMatToEigen<::cuMat::Flags::ColumnMajor>
{
    enum
    {
        value = ::Eigen::StorageOptions::ColMajor
    };
};
template <>
struct StorageCuMatToEigen<::cuMat::Flags::RowMajor>
{
    enum
    {
        value = ::Eigen::StorageOptions::RowMajor
    };
};
...
{
template <>
struct NumTraits<CUMAT_NAMESPACE cfloat> : NumTraits<std::complex<float>>
{
};
template <>
struct NumTraits<CUMAT_NAMESPACE cdouble> : NumTraits<std::complex<double>>
{
};
}  // namespace Eigen
