...
TEST_CASE("axis", "[reduce]")
{
    ...
    {  //none
        INFO("reduce: none");
        int expected[2][3][4] = {{{5, 2, 4, 1}, {8, 5, 6, 2}, {-5, 0, 3, -9}},
                                 {{11, 0, 0, 3}, {-7, -2, -4, 1}, {9, 4, 7, -7}}};
    ...
    {  //column
        INFO("reduce: column");
        int expected[2][3][1] = {{{12}, {21}, {-11}}, {{14}, {-12}, {13}}};
    ...
    {  //row
        INFO("reduce: row");
        int expected[2][1][4] = {{{8, 7, 13, -6}}, {{13, 2, 3, -3}}};
    ...
    {  //batch
        INFO("reduce: batch");
        int expected[1][3][4] = {{{16, 2, 4, 4}, {1, 3, 2, 3}, {4, 4, 10, -16}}};
