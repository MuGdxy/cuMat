...
#define BINARY_OP_HELPER(name, cuMatFn, eigenFn, min, max)                                                                               \
    ...
    {                                                                                                                                    \
        ...
        {                                                                                                                                \
            ...
            m_host1[i] = _Scalar((min) + ((max) - (min)) / 2)                                                                            \
                         + _Scalar(((max) - (min)) / 2) * m_host1[i].array();                                                            \
            m_host2[i].setRandom(rows, cols);                                                                                            \
            m_host2[i] = _Scalar((min) + ((max) - (min)) / 2)                                                                            \
                         + _Scalar(((max) - (min)) / 2) * m_host2[i].array();                                                            \
        }                                                                                                                                \
                                                                                                                                         \
        ...
        {                                                                                                                                \
            auto slice1 =                                                                                                                \
                cuMat::Matrix<_Scalar, _Rows, _Cols, 1, cuMat::ColumnMajor>::fromEigen(                                                  \
                    m_host1[i]);                                                                                                         \
        ...
        cuMat::Matrix<_Scalar, _Rows, _Cols, _Batches, _Flags> m_deviceRet = cuMatFn;                                                    \
                                                                                                                                         \
        std::vector<Eigen::Matrix<_Scalar, Eigen::Dynamic, Eigen::Dynamic, cuMat::eigen::StorageCuMatToEigen<_Flags>::value>> m_hostRet( \
            batches);                                                                                                                    \
        for(cuMat::Index i = 0; i < batches; ++i)                                                                                        \
        {                                                                                                                                \
        ...
        {                                                                                                                                \
            ...
            Eigen::Matrix<_Scalar, Eigen::Dynamic, Eigen::Dynamic, cuMat::eigen::StorageCuMatToEigen<_Flags>::value> lhs =               \
                eigenFn;                                                                                                                 \
