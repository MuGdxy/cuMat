...
{
    float data1[2][3][4] = {{{5, 2, 4, 1}, {8, 5, 6, 2}, {-5, 0, 3, -9}},
                            {{11, 0, 0, 3}, {-7, -2, -4, 1}, {9, 4, 7, -7}}};
    float data2[2][3][4] = {{{4, 3, 4.5, 1.5}, {8, 4, 6, 2}, {-6, 0.1, 3, -10}},
                            {{12, 0, 0, 2.5}, {-5, -2, -5, -1}, {-9, 4, 7, -7}}};
    ...
    SECTION("equal")
    {
        bool expected[2][3][4] = {{{false, false, false, false},
    ...
    SECTION("less")
    {
        bool expected[2][3][4] = {{{false, true, true, true},
    ...
    SECTION("greater")
    {
        bool expected[2][3][4] = {{{true, false, false, false},
                                   {false, true, false, false},
