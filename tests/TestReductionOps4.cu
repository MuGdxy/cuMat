...
{
    int data[2][4][4]{{{5, 2, 4, 1}, {8, 5, 6, 2}, {-5, 0, 3, -9}, {3, 7, 2, 1}},
                      {{11, 0, 0, 3}, {-7, -2, -4, 1}, {9, 4, -7, -7}, {8, 3, 4, -4}}};

    int expected[2][1][1]{{{14}}, {{-2}}};
...
TEST_CASE("norm", "[reduce]")
{
    ...
    double expectedSquared[2][1][1]{{{46}}, {{130}}};
    double expected[2][1][1]{{{6.782329983125268139064556326626}},
