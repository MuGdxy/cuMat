...
int main()
{
    ...
    cout << "Full reduction: "
         << mat.sum<ReductionAxis::Row | ReductionAxis::Column | ReductionAxis::Batch>()
                .eval()
         << endl;
    cout << "dynamic version: "
         << mat.sum(ReductionAxis::Row | ReductionAxis::Column | ReductionAxis::Batch)
                .eval()
         << endl;
    ...
    cout << "Along rows and columns: "
         << mat.sum<ReductionAxis::Row | ReductionAxis::Column>().eval() << endl;
}
